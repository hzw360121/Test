...
namespace GoodLuck
{
    ...
    public class SQLiteHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                //return ConfigurationManager.AppSettings["SQLiteConnectionString"].ToString();
                return ConfigHelper.GetValue("SQLiteConnectionString");
            }
        }
        ...
        public static int ExecuteNoQuery(string sql, params SQLiteParameter[] parms)
        {
        ...
        public static DataTable GetList(string sql, params SQLiteParameter[] parms)
        {
            using (SQLiteConnection con = new SQLiteConnection(ConnectionString))
            {
        ...
        public static int ExecuteNonQuery(SQLiteConnection cn, string commandText, params SQLiteParameter[] paramList)
        {
